    ...
    <div className="fixed inset-0 bg-background z-[10000] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-surface border border-borderRaw rounded-2xl p-6 space-y-4 shadow-2xl max-h-[85vh] flex flex-col">
        ...
        <div className="text-xs text-accent/70 space-y-3 overflow-y-auto flex-1 pr-1">
          <p><strong>1. O que é o ONDE.</strong> Uma plataforma colaborativa para descobrir e compartilhar o que está acontecendo na cidade em tempo real, através de relatos de usuários, estabelecimentos cadastrados ou locais recomendados.</p>
          <p><strong>2. Conteúdo publicado.</strong> Você é responsável pelo que publica. Não são permitidos discurso de ódio, assédio, conteúdo ilegal, spam ou desinformação. Publicações podem ser removidas pela moderação sem aviso prévio.</p>
          ...
          <p><strong>4. Publicações anônimas.</strong> Mesmo posts marcados como anônimos ficam vinculados internamente à sua conta, por segurança e moderação — o anonimato é só perante outros usuários.</p>
          ...
          <p><strong>6. Alterações.</strong> Essas diretrizes podem mudar conforme o app evolui. Alterações relevantes serão comunicadas.</p>
        </div>
